...
export const metadata: Metadata = {
  title: 'О компании – Производитель бытовок | Мир бытовок',
  description: 'О компании Мир бытовок. Производство бытовок с 2010 года. Собственная производственная база. Опыт, качество, надежность.',
  keywords: 'о компании, производитель бытовок, Мир бытовок, производство блок-контейнеров',
}
...
export default function AboutPage() {
  ...
  const timeline = [
    ...
    },
    {
      year: '2023',
      title: 'Лидер рынка',
      description: '2000+ бытовок изготовлено. Надежный производитель с многолетним опытом.'
    }
  ]
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-industrial-700">
              ...
              <p>
                Мы работаем по всей России. Наша компания обеспечивает 
