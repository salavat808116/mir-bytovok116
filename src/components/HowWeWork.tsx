  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="card h-full">
                {/* Номер этапа */}
                <div className="absolute -top-3 -left-3 w-12 h-12 bg-primary-600 text-white rounded-lg flex items-center justify-center font-bold text-lg shadow-md">
                  {step.number}
                </div>
                ...
                {/* Заголовок */}
                <h3 className="text-lg font-bold text-industrial-900 mb-3">
                  {step.title}
                </h3>
        ...
        {/* CTA блок */}
        <div className="mt-16 text-center bg-primary-50 rounded-lg p-8 border border-primary-200">
