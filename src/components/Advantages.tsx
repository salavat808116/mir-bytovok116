  ...
  const advantages = [
    {
      ...
      description: 'Быстрая доставка бытовок по Казани и Республике Татарстан в день заказа'
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-industrial-600 max-w-2xl mx-auto">
            Мы предлагаем полный спектр услуг по производству, продаже и аренде бытовок
            с гарантией качества и лучшими ценами в регионе
          </p>
        </div>
